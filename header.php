...
<html>
<head>
	<title>Bakery Vannangdam</title>
	<link rel="icon" type="image/icon" href"kc.ico">
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 20px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +628343482151</span>
				</div>


				<div class="col-md-4"  style="padding: 20px;">
					<span><i class="glyphicon glyphicon-envelope"></i> vannangdam.bakery@gmail.com</span>
				</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #000000"><b>VANNANGDAM-BAKERY</b></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: white;">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="manual.php" style="color:#000">Manual Aplikasi</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
